...
public class OpenNLP {
    ...
    public static String CHUNKER_MODEL = "resources/models/en-chunker.bin";
    public static String LEMMATIZER_DICT = "resources/models/en-lemmatizer.dict";
    public static String NAME_MODEL = "resources/models/en-ner-person.bin";
    public static String ENTITY_XXX_MODEL = "resources/models/en-ner-xyz.bin";
